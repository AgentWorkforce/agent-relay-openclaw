 ...
 *
 * Callers should maintain a single shared HarnessDriverClient instance and pass
 * it to every deliverMessage() call. Creating a client per message is wasteful
 * and was removed in favor of this shared-client pattern.
 */
