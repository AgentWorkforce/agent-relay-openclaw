...
export function generateSoulMd(
  ...
  return [
    ...
    'If a send/reply fails with "Not registered", re-run setup rather than self-registering.',
    'Self-termination is not automatic. Only output /exit on its own line when explicitly instructed to terminate.',
    '',
    '## Personality',
    '',
