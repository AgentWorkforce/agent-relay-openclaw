...
Use this section when Relaycast transport works (you can read via `message.inbox.check` / `message.list`) but messages do **not** auto-inject into the OpenClaw UI stream.
